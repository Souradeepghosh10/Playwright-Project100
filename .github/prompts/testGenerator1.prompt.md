...
4. Create both positive and negative cases for each significant feature and tab navigations
...
1. Generate a single `practice-test.spec.ts` file in tests folder with all tests
